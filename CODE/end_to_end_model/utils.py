...
def create_model(vector_length=128):
    ...
    model = Sequential()
    # add some linear layers with optional dropout and max pooling
    model.add(Dense(128, activation="relu", input_shape=(vector_length,)))
    ...
    # # add a softmax layer to get the probabilities of each class
